...
#set your working directory wherever that sample file with HIV data from iLearn is
setwd("~/Desktop/EECBData/BioinfoRData/")

#replace the name of the file in here with whatever the name of that iLearn file was (I renamed it because it was too long)
testfunction <- CpG_finder("HIVpracticedata.csv")